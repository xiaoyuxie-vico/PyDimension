#!/usr/bin/env python3
"""
Legacy script: standalone dimensional analysis (PyDimension 2.0).

In PyDimension 3.0, dimensional analysis is merged into the unified
data_preprocessing stage.  Use ``preprocess_data.py`` with a 3.0 config
instead.  This script is kept for backward compatibility with 2.0 workflows.
"""
