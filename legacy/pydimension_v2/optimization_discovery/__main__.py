"""
Command-line interface for optimization and discovery module.
"""
...
def main():
    """Main entry point for optimization and discovery CLI."""
...
Examples:
  ...
  python -m pydimension.optimization_discovery --config pydimension/configs/config_synthetic.json
