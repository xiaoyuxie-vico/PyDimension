...
class OptimizationDiscoveryConfig:
    ...
    symmetry_type: str = "translational"  # symmetry family to test first
    encoder_name: str = "translational"  # encoder used before the discovery backend
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> 'OptimizationDiscoveryConfig':
        ...
        return cls(
            ...
            symmetry_type=optimization_discovery.get('symmetry_type', 'translational'),
            encoder_name=optimization_discovery.get('encoder_name', optimization_discovery.get('symmetry_type', 'translational')),
