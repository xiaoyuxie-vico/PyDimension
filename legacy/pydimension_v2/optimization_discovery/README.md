...
For PyDimension 3.0, the renamed discovery stage now lives in `pydimension/symmetry_discovery/`.

This package is retained as the preserved 2.0 neural discovery backend:
