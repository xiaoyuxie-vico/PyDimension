...
For the PyDimension 3.0 path, this stage has been renamed to `intrinsic_coordinate`.

This directory is retained as the legacy 2.0 implementation and benchmark backend. The preferred 3.0 entrypoint is `intrinsic_coordinate.py`, and the preferred 3.0 package is `pydimension/intrinsic_coordinate/`.
