#!/usr/bin/env python3
"""
Legacy script to perform constraint filtering using PyDimension 2.0.

This is a convenience script that can be run directly from the package root.
For the PyDimension 3.0 path, use `intrinsic_coordinate.py` instead.
"""
...
def main():
    """Perform legacy constraint filtering from config file or use command-line arguments."""
    import argparse
