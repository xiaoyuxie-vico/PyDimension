#!/usr/bin/env python3
"""
Legacy script: optimization discovery (PyDimension 2.0).

In PyDimension 3.0, this stage is replaced by ``discover_symmetry.py``
which uses symmetry-aware encoders.  This script is kept for backward
compatibility with 2.0 workflows.
"""
